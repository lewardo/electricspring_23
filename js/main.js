...
$(document).ready(() => {
    ...
    $("#open-schedule").one("click tap", () => {
    	$("#open-schedule").glitch({
        ...
        $("#open-schedule").on("click tap", () => {
        	window.open("https://www.electricspring.co.uk/assets/ES23-programme.pdf")
        });
    })
    
    $("#open-tickets").on("click tap", () => {
    	$("#open-tickets").glitch({
	     chars: "abcdefghijklmnopqrstuvwxyz",
	     charTime: 8,
        ...
        setTimeout(() => window.location.href = "https://www.eventbrite.com/cc/electric-spring-2023-1556009", 200)
    })
});
